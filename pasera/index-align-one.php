				...
				<tbody>
					...
					<tr style="float: left;">
						...
						<td style="padding-top: 15px;">
							<button id="btn1" onclick="_tables.fkbtn(1);"><?php echo $BUTTON; ?></button>
						</td>
					</tr>
				</tbody>
			</table>
